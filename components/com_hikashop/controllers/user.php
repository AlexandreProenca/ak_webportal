...
class userController extends hikashopController {
	...
	public function activate() {
		...
		$activation = hikashop_getEscaped(hikaInput::get()->getVar('activation', '', '', 'cmd'));
		...
		$model = null;
		if(HIKASHOP_J40) {
			$model = $app->bootComponent('com_users')->getMVCFactory()->createModel('Registration', 'Site', array('ignore_request' => true));
		} elseif(HIKASHOP_J30) {
