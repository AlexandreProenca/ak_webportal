...
$showPrice = $this->params->get('show_price', '-1');
if($showPrice == '-1')
	$showPrice = hikashop_config()->get('show_price');
$listingMicrodata = !empty($showPrice);
...
if($carouselEffect=='slide'){
	if($direction=='horizontal'){
		...
		if($this->params->get('div_item_layout_type')=='fade' || $this->params->get('div_item_layout_type')=='slider_vertical' || $this->params->get('div_item_layout_type')=='slider_horizontal' || $this->params->get('div_item_layout_type')=='img_pane'){
			...
			echo '<ul id="hikashop_only_products_'.$mainDivName.'"'.($listingMicrodata ? ' itemscope itemtype="https://schema.org/ItemList"' : '').' style="position:relative; margin:0px; margin-top: 0px;padding-left:0px;list-style:none; width:'.$slideWidth.'px; height:'.$heightProd.'px;">';
		}
		else{
			...
			echo '<ul id="hikashop_only_products_'.$mainDivName.'"'.($listingMicrodata ? ' itemscope itemtype="https://schema.org/ItemList"' : '').' style="position:relative; margin:0px; margin-top: 0px;padding-left:0px;list-style:none; width:'.$slideWidth.'px; ">';
		}
	}
	else{
		...
		if($this->params->get('div_item_layout_type')=='fade' || $this->params->get('div_item_layout_type')=='slider_vertical' || $this->params->get('div_item_layout_type')=='slider_horizontal' || $this->params->get('div_item_layout_type')=='img_pane'){
			echo '<div id="hikashop_main_slider_'.$mainDivName.'" class="hikashop_main_carousel_div hikashop_subcontainer '.$this->borderClass.'" style=" padding-bottom:0px; padding-top:0px; margin: auto; overflow:hidden; position:relative; width:'.$widthProd.'px; height:'.$heightProd.'px;">';
			echo '<ul id="hikashop_only_products_'.$mainDivName.'"'.($listingMicrodata ? ' itemscope itemtype="https://schema.org/ItemList"' : '').' style="position:relative; margin:0px; margin-top: 0px;padding-left:0px;list-style:none; width:'.$widthProd.'px; height:'.$slideHeight.'px;">';
		}
		else{
	...
	foreach($this->rows as $row){
		...
		$this->row =& $row;
		if($this->params->get('div_item_layout_type')=='fade' || $this->params->get('div_item_layout_type')=='slider_vertical' || $this->params->get('div_item_layout_type')=='slider_horizontal' || $this->params->get('div_item_layout_type')=='img_pane'){
			?><li style="margin: <?php echo $margin; ?>px; height:<?php echo $height; ?>px; width:<?php echo $width; ?>px;float:left; list-style:none; position:relative;"<?php if($listingMicrodata) { ?> itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"<?php } ?>><?php if($listingMicrodata) { ?><meta itemprop="position" content="<?php echo $itemPosition; ?>"/><?php } ?><?php
		}
		else{
			?><li style="margin: <?php echo $margin; ?>px; width:<?php echo $width; ?>px;float:left; list-style:none; text-align:center"<?php if($listingMicrodata) { ?> itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"<?php } ?>><?php if($listingMicrodata) { ?><meta itemprop="position" content="<?php echo $itemPosition; ?>"/><?php } ?><?php
		}
	...
	if($direction=='horizontal'){
		if($this->params->get('display_button')) echo '<table style="margin:auto; "><tr><th><a id="hikashop_previous_button_'.$mainDivName.'"><img class="hikashop_slider_button hikashop_slider_button" src="'.HIKASHOP_IMAGES.'icons/prev.png" alt="hikashop_previous_button_'.$mainDivName.'" /></a></th><th>';
		echo '<div id="hikashop_slideshow_fade_'.$mainDivName.'" class="hikashop_main_carousel_div hikashop_subcontainer '.$this->borderClass.'"'.($listingMicrodata ? ' itemscope itemtype="https://schema.org/ItemList"' : '').' style="padding-bottom:0px; padding-top:0px; overflow:hidden; width:'.$widthProd.'px; height:'.$heightProd.'px; position:relative;">';
	}
	else{
		if($this->params->get('display_button'))  echo '<table style="margin:auto;"><tr><th style="text-align:center;"><a id="hikashop_previous_button_'.$mainDivName.'"><img class="hikashop_slider_button hikashop_slider_button" src="'.HIKASHOP_IMAGES.'icons/up.png" style="margin:auto; text-align:center;" alt="up" /></a></th></tr><tr><th>';
		echo '<div id="hikashop_slideshow_fade_'.$mainDivName.'" class="hikashop_main_carousel_div hikashop_subcontainer '.$this->borderClass.'"'.($listingMicrodata ? ' itemscope itemtype="https://schema.org/ItemList"' : '').' style="overflow:hidden; width:'.$widthProd.'px; height:'.$heightProd.'px; position:relative;">';
	}

	$count=0; $nbSlide=0; $itemPosition2=0;
	foreach($this->rows as $row){
		$itemPosition2++;
		if($count==0){
			$zindex = 3;
		...
		$this->row =& $row;
		?><div style="margin: <?php echo $margin; ?>px; height:<?php echo $height; ?>px; width:<?php echo $width; ?>px;float:left; "<?php if($listingMicrodata) { ?> itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"<?php } ?>><?php if($listingMicrodata) { ?><meta itemprop="position" content="<?php echo $itemPosition2; ?>"/><?php } ?><?php
		$this->setLayout('listing_'.$this->params->get('div_item_layout_type'));
		echo $this->loadTemplate();
		?></div><?php
		if($count==$products-1){
