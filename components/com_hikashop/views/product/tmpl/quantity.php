...
<?php
if($add_to_cart) {
	$addToDivName = !empty($this->currentFormName) ? $this->currentFormName : 'hikashop_product_form';
	$attributes = ' class="' . $css_button . ' ' . $css_button_cart. '" onclick="if(window.hikashop.addToCart) { return window.hikashop.addToCart(this); }" data-addToCart="'.$this->row->product_id.'" data-addTo-div="' . $addToDivName . '" data-addTo-class="add_in_progress"';
...
if($add_to_wishlist) {
	$addToDivName = !empty($this->currentFormName) ? $this->currentFormName : 'hikashop_product_form';
	$attributes = ' class="' . $css_button . ' ' . $css_button_wishlist. '" onclick="if(window.hikashop.addToWishlist) { return window.hikashop.addToWishlist(this); }" data-addToWishlist="'.$this->row->product_id.'" data-addTo-div="' . $addToDivName . '" data-addTo-class="add_in_progress"';
	if(!empty($this->last_quantity_field_id))
