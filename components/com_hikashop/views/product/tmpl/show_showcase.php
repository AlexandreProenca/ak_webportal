...
?>
<div id="hikashop_product_top_part" class="hikashop_product_top_part hikashop_product_showcase_layout">
<!-- TOP BEGIN EXTRA DATA -->
<?php if(!empty($this->element->extraData->topBegin)) { echo implode("\r\n",$this->element->extraData->topBegin); } ?>
<!-- EO TOP BEGIN EXTRA DATA -->
	<h1 class="hikashop_showcase_title">
<!-- NAME -->
...
<?php if ($this->config->get('show_code')) { ?>
		<span id="hikashop_product_code_main" class="hikashop_product_code_main hikashop_showcase_code"><?php
...
<!-- VOTE -->
	<div id="hikashop_product_vote_mini" class="hikashop_product_vote_mini hikashop_showcase_vote"><?php
...
<div class="hikashop_showcase_main">
	<div id="hikashop_product_left_part" class="hikashop_product_left_part hikashop_showcase_image_area">
...
<div id="hikashop_product_right_part" class="hikashop_product_right_part hikashop_showcase_purchase_bar">
...
<?php
?>
	<div class="hikashop_showcase_purchase_price">
		<span id="hikashop_product_price_main" class="hikashop_product_price_main hikashop_showcase_price">
<?php
...
<!-- ADD TO CART BUTTON -->
	<div class="hikashop_showcase_purchase_actions">
<?php
	if(empty($this->element->characteristics) || $this->params->get('characteristic_display') != 'list') {
?>
		<div id="hikashop_product_quantity_main" class="hikashop_product_quantity_main hikashop_showcase_cart"><?php
			$this->row =& $this->element;
			$this->formName = $form;
...
<!-- END GRID -->
<div id="hikashop_product_bottom_part" class="hikashop_product_bottom_part hikashop_showcase_bottom">
<!-- BOTTOM BEGIN EXTRA DATA -->
<?php if(!empty($this->element->extraData->bottomBegin)) { echo implode("\r\n",$this->element->extraData->bottomBegin); } ?>
<!-- EO BOTTOM BEGIN EXTRA DATA -->
<div class="hk-row-fluid hikashop_showcase_details">
	<div class="hkc-md-7 hikashop_showcase_details_left">
<!-- DESCRIPTION -->
		<div id="hikashop_product_description_main" class="hikashop_product_description_main hikashop_showcase_description"><?php
...
<!-- EO FILES -->
	...
	<div class="hkc-md-5 hikashop_showcase_details_right">
<!-- DIMENSIONS -->
<?php
...
?>
<style>
.hikashop_product_showcase_layout {
	margin-bottom: 6px;
	border-bottom: 2px solid #eee;
	padding-bottom: 10px;
}
.hikashop_showcase_title {
	margin: 0 0 4px 0;
	font-size: 1.6em;
}
.hikashop_showcase_code {
...
.hikashop_showcase_vote {
	display: inline-block;
}

.hikashop_showcase_image_area {
	max-width: 800px;
	margin: 0 auto;
	padding: 20px 0;
}
.hikashop_showcase_image_area .hikashop_global_image_div {
	display: flex;
	gap: 14px;
}
.hikashop_showcase_image_area .hikashop_small_image_div {
	display: flex;
...
.hikashop_showcase_image_area .hikashop_small_image_div a {
	display: block;
}
.hikashop_showcase_image_area .hikashop_small_image_div img {
	width: 80px;
	height: 80px;
	object-fit: cover;
...
.hikashop_showcase_image_area .hikashop_small_image_div img.hikashop_child_image_active {
	border-color: #0066cc;
}
.hikashop_showcase_image_area .hikashop_main_image_div {
	flex: 1;
	min-width: 0;
}
.hikashop_showcase_image_area .hikashop_product_main_image_thumb {
	height: auto !important;
}
.hikashop_showcase_image_area .hikashop_product_main_image {
	height: auto !important;
	width: 100%;
	text-align: center;
}
.hikashop_showcase_image_area .hikashop_product_main_image img {
	max-width: 100%;
	height: auto;
	max-height: 500px;
	object-fit: contain;
...
.hikashop_showcase_purchase_price {
	flex-shrink: 0;
}
.hikashop_showcase_price {
	font-size: 1.6em;
	font-weight: bold;
}
.hikashop_showcase_purchase_actions {
	display: flex;
	align-items: center;
	gap: 12px;
	flex-wrap: wrap;
...
.hikashop_showcase_cart {
	display: inline-block;
}

.hikashop_showcase_cart .hikashop_quantity_form .hikabtn {
	padding: 2px 8px;
}

.hikashop_showcase_bottom {
	margin-top: 24px;
}
.hikashop_showcase_details {
	display: flex;
	flex-wrap: wrap;
	gap: 30px;
}
.hikashop_showcase_details_left {
	flex: 0 0 calc(58% - 15px);
	max-width: calc(58% - 15px);
	line-height: 1.7;
}
.hikashop_showcase_details_right {
	flex: 1;
	min-width: 0;
	background: #fafafa;
