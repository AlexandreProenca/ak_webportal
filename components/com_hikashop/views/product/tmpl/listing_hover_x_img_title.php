...
?>
		<a class="hika_hover_x_btn hika_hover_x_btn_previous" style="width:20px;margin-left:-5px;"  onclick="hover_x_slide('-', this); return false;"
			...
			<i class="fas fa-chevron-left" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_PREVIOUS'); ?></span>
		</a>
<?php 
	}
?>
...
?>
		<a class="hika_hover_x_btn hika_hover_x_btn_next" style="width:20px;margin-right:-5px;" onclick="hover_x_slide('+', this); return false;"
			...
			<i class="fas fa-chevron-right" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_NEXT'); ?></span>
		</a>
<?php 
	}
?>
...
?>
	<div class="hikashop_product_characteristics_on_listing">
<?php
