...
?>
			<ul class="hikashop_product_list <?php echo $this->params->get('ul_class_name'); ?>" data-consistencyheight="true"<?php if($listingMicrodata) { ?> itemscope itemtype="https://schema.org/ItemList"<?php } ?>>
<?php
		$itemPosition = 0;
...
?>
				<li class="<?php echo implode(' ', $hk_main_classes); ?>" <?php echo $width; ?> <?php if($listingMicrodata) { ?>itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"<?php } ?>>
