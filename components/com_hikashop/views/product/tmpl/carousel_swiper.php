...
?>
        <div class="swiper <?php echo $direction; ?>" id="hikashop_carousel_<?php echo $mainDivName; ?>" <?php if($rtl){ ?>dir="rtl"<?php } ?>>
            <div class="swiper-wrapper"<?php if($listingMicrodata) { ?> itemscope itemtype="https://schema.org/ItemList"<?php } ?>>
<?php
$itemPosition = 0;
foreach ($this->rows as $row) {
    ...
    $this->row = &$row;
?>
                <div class="swiper-slide hikashop_carousel_item hikashop_subcontainer" <?php if($listingMicrodata) { ?>itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"<?php } ?>>
