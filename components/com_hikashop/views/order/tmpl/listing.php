...
<?php
			...
			if(hikashop_get('class.withdrawal')->isWithdrawable($row)) {
				$url = hikashop_completeLink('withdrawal&task=form&order_id='.$row->order_id.$url_itemid);
				$dropData[] = array(
					'name' => '<i class="fas fa-undo"></i> '. JText::_('HIKA_WITHDRAW_FROM_CONTRACT'),
					'link' => $url
				);
			}
...
<?php if($row->order_id == $this->row->order_id) { ?>
						<a class="hikabtn hikabtn-default " data-toggle="hk-tooltip" data-title="<?php echo $this->escape(JText::_('HIDE_PRODUCTS')); ?>" href="#" onclick="return window.localPage.handleDetails(this, <?php echo (int)$row->order_id; ?>);"><i class="fas fa-angle-up" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIDE_PRODUCTS'); ?></span></a>
<?php } else { ?>
						<a class="hikabtn hikabtn-default" data-toggle="hk-tooltip" data-title="<?php echo $this->escape(JText::_('DISPLAY_PRODUCTS')); ?>" href="#" onclick="return window.localPage.handleDetails(this, <?php echo (int)$row->order_id; ?>);"><i class="fas fa-angle-down" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('DISPLAY_PRODUCTS'); ?></span></a>
<?php } ?>
