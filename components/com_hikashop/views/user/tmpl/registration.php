...
<div class="hkform-group control-group hikashop_registration_name_line" id="hikashop_registration_name_line">
	...
	<div class="hkc-sm-8">
		<input type="text" name="data[register][name]" id="register_name" value="<?php echo $this->escape($this->mainUser->get( 'name' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?> validate-username required" maxlength="50" aria-required="true" aria-describedby="register_name_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);" />
...
<div class="hkform-group control-group hikashop_registration_username_line" id="hikashop_registration_username_line">
	...
	<div class="hkc-sm-8">
		<input type="text" id="register_username" name="data[register][username]" value="<?php echo $this->escape($this->mainUser->get( 'username' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?> required validate-username" maxlength="25" aria-required="true" aria-describedby="register_username_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);" />
...
<div class="hkform-group control-group hikashop_registration_email_line">
	...
	<div class="hkc-sm-8">
		<input <?php if($this->config->get('show_email_confirmation_field',0)){echo ' autocomplete="off"';} ?> type="text" id="register_email" name="data[register][email]" value="<?php echo $this->escape($this->mainUser->get( 'email' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?> required validate-email" maxlength="100" aria-required="true" aria-describedby="register_email_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);" />
...
?>
		<input autocomplete="off" class="<?php echo HK_FORM_CONTROL_CLASS; ?> required  validate-password" type="password" id="register_password" name="data[register][password]" value="" aria-required="true" aria-describedby="register_password_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);" />
...
?>
		<input autocomplete="off" class="<?php echo HK_FORM_CONTROL_CLASS; ?> required  validate-passverify" type="password" id="register_password2" name="data[register][password2]" value="" aria-required="true" aria-describedby="register_password2_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);" />
...
?>
<div class="hkform-group control-group hikashop_registration_button_line">
<label class='hkc-sm-4 hkcontrol-label'></label>
<div class="hkc-sm-8">
