...
<!-- NAME -->
	<div class="hkform-group control-group hikashop_registration_name_line" id="hikashop_registration_name_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="text" name="data[register][name]" id="register_name" value="<?php echo $this->escape($this->mainUser->get( 'name' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?>" size="30" maxlength="50" aria-required="true" aria-describedby="register_name_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);"/>
			<span id="register_name_error" class="hikashop_field_error_msg" style="display:none;" role="alert"></span>
		</div>
	</div>
<!-- EO NAME -->
<!-- USERNAME -->
	<div class="hkform-group control-group hikashop_registration_username_line" id="hikashop_registration_username_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="text" name="data[register][username]" id="register_username" value="<?php echo $this->escape($this->mainUser->get( 'username' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?> validate-username" maxlength="25" size="30" aria-required="true" aria-describedby="register_username_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);"/>
			<span id="register_username_error" class="hikashop_field_error_msg" style="display:none;" role="alert"></span>
		</div>
	</div>
<!-- EO USERNAME -->
<?php
...
<!-- EMAIL -->
	<div class="hkform-group control-group hikashop_registration_email_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input <?php if($this->config->get('show_email_confirmation_field',0)){echo ' autocomplete="off"';} ?> type="text" name="data[register][email]" id="register_email" value="<?php echo $this->escape($this->mainUser->get( 'email' ));?>" class="<?php echo HK_FORM_CONTROL_CLASS; ?> validate-email" maxlength="100" size="30" aria-required="true" aria-describedby="register_email_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);"/>
			<span id="register_email_error" class="hikashop_field_error_msg" style="display:none;" role="alert"></span>
		</div>
	</div>
<!-- EO EMAIL -->
<!-- EMAIL CONFIRMATION -->
...
?>
			<input autocomplete="off" type="password" name="data[register][password]" id="register_password" value="" class="<?php echo HK_FORM_CONTROL_CLASS; ?> validate-password" size="30" aria-required="true" aria-describedby="register_password_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);">
			<span id="register_password_error" class="hikashop_field_error_msg" style="display:none;" role="alert"></span>
<?php 
	}
?>
		</div>
...
?>
			<input autocomplete="off" type="password" name="data[register][password2]" id="register_password2" value="" class="<?php echo HK_FORM_CONTROL_CLASS; ?> validate-password" size="30" aria-required="true" aria-describedby="register_password2_error" onblur="if(document.formvalidator) document.formvalidator.validate(this); if(window.hikashop.updateFieldError) window.hikashop.updateFieldError(this);">
			<span id="register_password2_error" class="hikashop_field_error_msg" style="display:none;" role="alert"></span>
<?php 
	}
?>
		</div>
...
if(!empty($this->extraFields[$type])) {
	...
	$this->idPrefix = 'hikashop_'.$type . '_' . $this->step . '_' . $this->module_position;
	$this->onChangeJs = "window.hikashop.toggleField(this,'{FIELD}','".$type . '_' . $this->step . '_' . $this->module_position."',0,'hikashop_');";
...
<?php
		...
		$this->inputPrefix = 'data['.$type.']';
		$this->idPrefix = 'hikashop_address_shipping_' . $this->step . '_' . $this->module_position;
		$this->onChangeJs = "window.hikashop.toggleField(this,'{FIELD}','address_shipping_" . $this->step . '_' . $this->module_position."',0,'hikashop_');";
