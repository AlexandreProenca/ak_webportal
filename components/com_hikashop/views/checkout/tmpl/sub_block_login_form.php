...
<!-- OLD USERNAME -->
	<div class="hkform-group control-group hikashop_login_username_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="text" id="username" name="login[username]" class="<?php echo HK_FORM_CONTROL_CLASS; ?>" alt="<?php echo JText::_('HIKA_USERNAME') ?>" placeholder="<?php echo JText::_('HIKA_USERNAME') ?>" size="18" />
		</div>
	</div>
<!-- EO OLD USERNAME -->
<!-- OLD PASSWORD -->
	...
	<div id="form-login-username" class="control-group">
		<div class="controls">
			<div class="input-prepend input-append">
				...
				<a href="<?php echo JRoute::_( $remind_url );?>" class="btn hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_USERNAME'); ?>"><i class="icon-question-sign" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_FORGOT_YOUR_USERNAME'); ?></span></a>
			</div>
		</div>
	</div>
<!-- EO USERNAME -->
	...
	<div id="form-login-password" class="control-group">
		<div class="controls">
			<div class="input-prepend input-append">
				...
				<a href="<?php echo JRoute::_( $reset_url );?>" class="btn hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_PASSWORD'); ?>"><i class="icon-question-sign" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_FORGOT_YOUR_PASSWORD'); ?></span></a>
			</div>
		</div>
	</div>
<!-- EO PASSWORD -->
