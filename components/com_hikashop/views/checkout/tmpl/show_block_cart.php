...
?>
		<tr class="row<?php echo $k; ?>" id="hikashop_cart_product_row_<?php echo $product->cart_product_id; ?>" data-product-id="<?php echo $product->product_id; ?>">
<!-- IMAGE -->
<?php
		if(!empty($this->options['show_cart_image'])) {
?>
...
<!-- EO SEPARATOR ROW -->
<!-- SUBTOTAL ROW -->
		<tr class="hikashop_cart_subtotal_row">
...
?>
		<tr class="hikashop_cart_coupon_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
...
?>
		<tr class="hikashop_cart_shipping_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
...
?>
		<tr id="hikashop_checkout_cart_additional_<?php echo str_replace(' ','_',$k); ?>_line" class="hikashop_cart_additional_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
...
?>
		<tr class="hikashop_cart_tax_row" id="hikashop_checkout_cart_tax_<?php echo $this->escape($tax->tax_namekey); ?>_line">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
...
?>
		<tr class="hikashop_cart_tax_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
			<td id="hikashop_checkout_cart_tax_title" class="hikashop_cart_tax_title hikashop_cart_title"><?php
				echo JText::_('TAXES');
			?></td>
...
?>
		<tr class="hikashop_cart_payment_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
...
<?php
		if(!empty($this->options['show_price'])) {
?>
		<tr class="hikashop_cart_total_row">
			<td colspan="<?php echo $row_count - 2; ?>" class="hikashop_cart_empty_footer"></td>
