...
<input type="hidden" name="new_payment_method" value="<?php echo hikaInput::get()->getCmd('new_payment_method','');?>"/>
<?php
...
<?php if(!empty($this->method->ask_owner)){ ?>
		<tr>
			...
			<td><span class="hikashop_credit_ccv"><?php echo htmlspecialchars($cc_owner); ?></span></td>
		</tr>
<?php } ?>
<?php if(!empty($this->method->ask_cctype)){ ?>
		<tr>
			...
			<td><span class="hikashop_credit_card_type"><?php echo htmlspecialchars($this->method->ask_cctype[$cc_type]);?></span></td>
		</tr>
<?php } ?>
		<tr>
		...
		<tr>
			...
			<td><span class="hikashop_credit_card_date"><?php echo (int)$cc_month."/".(int)$cc_year;?></span></td>
		</tr>
