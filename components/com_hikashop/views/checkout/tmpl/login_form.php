	...
	<div id="form-login-username" class="control-group">
		<div class="controls">
			<div class="input-prepend input-append">
				...
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind');?>" class="btn hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_USERNAME'); ?>"><i class="icon-question-sign" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_FORGOT_YOUR_USERNAME'); ?></span></a>
			</div>
		</div>
	</div>
	<div id="form-login-password" class="control-group">
		<div class="controls">
			<div class="input-prepend input-append">
				...
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset');?>" class="btn hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_PASSWORD'); ?>"><i class="icon-question-sign" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('HIKA_FORGOT_YOUR_PASSWORD'); ?></span></a>
			</div>
		</div>
	</div>
<?php if(JPluginHelper::isEnabled('system', 'remember')) { ?>
