...
class hikashopCartHelper extends stdClass {
	...
	public function __construct() {
		...
		$chromePath = JPATH_THEMES.DS.$app->getTemplate().DS.$chromeSubDir.DS.'hikashop_button.php';
		if(!file_exists($chromePath)) {
			$parentTemplate = hikashop_getParentTemplate();
			if(!empty($parentTemplate)) {
				$chromePath = JPATH_THEMES.DS.$parentTemplate.DS.$chromeSubDir.DS.'hikashop_button.php';
			}
		}
		if(file_exists($chromePath)) {
