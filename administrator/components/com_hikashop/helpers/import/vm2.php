...
class hikashopImportvm2Helper extends hikashopImportHelper
{
	...
	function loadConfiguration()
	{
		...
		$this->options->uploadfolder = rtrim((string)JPath::clean(html_entity_decode($this->options->uploadfolder)),DS.' ').DS;
		...
		$this->options->uploadsecurefolder = rtrim((string)JPath::clean(html_entity_decode($this->options->uploadsecurefolder)),DS.' ').DS;
	...
	function finishImport()
	{
		...
		$infos = $class->getByName('system','vm_redirect',false);
		if($infos){
