...
class hikashopSeoHelper {
	...
	public function autoFillKeywordMeta(&$element, $object) {
		$this->autoFillMeta($element, $object);
		$this->autoFillKeyword($element, $object);
	}

	public function autoFillMeta(&$element, $object) {
	...
	public function autoFillKeyword(&$element, $object) {
