...
<script>
	(function(){
		var bind = function(){ Fancybox.bind(\'[data-fancybox="'.$gallery.'"]\', {}); };
		if(typeof Fancybox !== "undefined") { bind(); return; }
		var existing = document.querySelector(\'script[data-hk-fancybox-loader="1"]\');
		if(existing){ existing.addEventListener("load", bind); return; }
		var css = document.createElement("link");
		css.rel = "stylesheet"; css.href = "'.HIKASHOP_CSS.'fancybox.css";
		document.head.appendChild(css);
		var s = document.createElement("script");
		s.src = "'.HIKASHOP_JS.'fancybox.js";
		s.setAttribute("data-hk-fancybox-loader", "1");
		s.addEventListener("load", bind);
