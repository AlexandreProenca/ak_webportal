...
class hikashopItemType extends hikashopType {
	...
	function loadFromTemplates($hikashopFiles) {
		...
		foreach ($templates as $template) {
			$overrideSubDir = defined('HIKASHOP_WORDPRESS') ? 'hikashop' : ('html' . DS . 'com_hikashop');
			$this->loadFromCustom($hikashopFiles, $template, $template . DS . $overrideSubDir . DS . 'product', $files);
			$this->loadFromCustom($hikashopFiles, $template, $template . DS . $overrideSubDir . DS . 'category', $files);
		}
	}
