...
<?php } ?>
	...
	echo JHTML::_('select.genericlist', $values, $this->type.'_address_default', 'class="custom-select hikashop_default_address_dropdown" style="width:100%;"', 'value', 'text', $current, 'hikashop_default_'.$this->type.'_address_selector');
