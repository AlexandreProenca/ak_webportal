...
<!-- ADDITIONAL TOP EXTRA DATA -->
<?php if(!empty($this->order->extraData->additionalTop)) { echo implode("\r\n", $this->order->extraData->additionalTop); } ?>
<!-- EO ADDITIONAL TOP EXTRA DATA -->
	<table class="admintable table">
<!-- ADDITIONAL TOP LINE EXTRA DATA -->
<?php if(!empty($this->order->extraData->additionalTopLine)) { echo implode("\r\n", $this->order->extraData->additionalTopLine); } ?>
<!-- EO ADDITIONAL TOP LINE EXTRA DATA -->
<!-- SUBTOTAL -->
...
?>
<!-- EO CUSTOM FIELDS -->
<!-- ADDITIONAL BOTTOM LINE EXTRA DATA -->
<?php if(!empty($this->order->extraData->additionalBottomLine)) { echo implode("\r\n", $this->order->extraData->additionalBottomLine); } ?>
<!-- EO ADDITIONAL BOTTOM LINE EXTRA DATA -->
	</table>
<!-- ADDITIONAL BOTTOM EXTRA DATA -->
<?php if(!empty($this->order->extraData->additionalBottom)) { echo implode("\r\n", $this->order->extraData->additionalBottom); } ?>
<!-- EO ADDITIONAL BOTTOM EXTRA DATA -->
<script type="text/javascript">
