...
?><div class="hikashop_order_import">
	<form action="index.php?option=com_hikashop&ctrl=order" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		<div class="hikashop_backend_tile_edition">
			<div class="hikashop_tile_block">
				<div class="hikashop_tile_title">
					<?php echo JText::_('ORDER_IMPORT_STEP_1'); ?>
				</div>
				<div class="hikashop_tile_content">
					<p><?php echo JText::_('ORDER_IMPORT_CSV_DESC'); ?></p>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="import_content" id="import_content" rows="10" style="width:100%;" placeholder="<?php echo htmlspecialchars("column1,column2\nvalue1,value2"); ?>"><?php if(!empty($this->import_content)) echo htmlspecialchars($this->import_content); ?></textarea>
						</div>
					</div>
