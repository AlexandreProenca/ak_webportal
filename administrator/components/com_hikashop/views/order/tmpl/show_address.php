...
?>
<!-- ADDRESS TOP EXTRA DATA -->
<?php if(!empty($address->extraData->addressTop)) { echo implode("\r\n", $address->extraData->addressTop); } ?>
<!-- EO ADDRESS TOP EXTRA DATA -->
<?php
if(!empty($this->order->$fields_type)) {
?>
<table class="admintable table">
<!-- ADDRESS TOP LINE EXTRA DATA -->
<?php if(!empty($address->extraData->addressTopLine)) { echo implode("\r\n", $address->extraData->addressTopLine); } ?>
<!-- EO ADDRESS TOP LINE EXTRA DATA -->
<!-- ADDRESS FIELDS EDIT -->
<?php
	if(isset($this->edit) && $this->edit === true ) {
...
?>
<!-- EO ADDRESS FIELDS SHOW -->
<?php
	}
?>
<!-- ADDRESS BOTTOM LINE EXTRA DATA -->
<?php if(!empty($this->order->extraData->addressBottomLine)) { echo implode("\r\n", $this->order->extraData->addressBottomLine); } ?>
<!-- EO ADDRESS BOTTOM LINE EXTRA DATA -->
</table>
<?php
}
?>
<!-- ADDRESS BOTTOM EXTRA DATA -->
<?php if(!empty($address->extraData->addressBottom)) { echo implode("\r\n", $address->extraData->addressBottom); } ?>
<!-- EO ADDRESS BOTTOM EXTRA DATA -->
<script type="text/javascript">
