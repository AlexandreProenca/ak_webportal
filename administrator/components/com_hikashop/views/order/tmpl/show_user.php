...
<!-- USER TOP EXTRA DATA -->
<?php if(!empty($this->order->extraData->userTop)) { echo implode("\r\n", $this->order->extraData->userTop); } ?>
<!-- EO USER TOP EXTRA DATA -->
<table class="admintable table">
<!-- USER TOP LINE EXTRA DATA -->
<?php if(!empty($this->order->extraData->userTopLine)) { echo implode("\r\n", $this->order->extraData->userTopLine); } ?>
<!-- EO USER TOP LINE EXTRA DATA -->
<!-- USER NAME -->
...
?>
<!-- EO EXTRA DATA -->
<!-- USER BOTTOM LINE EXTRA DATA -->
<?php if(!empty($this->order->extraData->userBottomLine)) { echo implode("\r\n", $this->order->extraData->userBottomLine); } ?>
<!-- EO USER BOTTOM LINE EXTRA DATA -->
</table>
<!-- USER BOTTOM EXTRA DATA -->
<?php if(!empty($this->order->extraData->userBottom)) { echo implode("\r\n", $this->order->extraData->userBottom); } ?>
<!-- EO USER BOTTOM EXTRA DATA -->
