	...
	<div class="hikashop_module_subblock_content">
		...
		<dl class="hika_options hikashop_mini_cart">
			<dt class="hikashop_option_name">
				<label><?php echo hikashop_hktooltip(JText::sprintf('HIKA_MINI_CART_DESC',JText::_('HIKASHOP_'.$this->type)), '', JText::sprintf('MINI_CART', JText::_('HIKASHOP_'.$this->type)), '', 0); ?></label>
			</dt>
