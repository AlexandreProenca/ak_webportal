...
?>
	...
	<div <?php echo $extra_id; ?> class="hkc-md-12 hikashop_listing_filters <?php echo $openfeatures_class; ?>">
<?php
	...
	echo '<div class="hk-row">';
		echo '<div class="hkc-md-2"></div>';
		echo '<div class="hkc-md-6">';
			echo '<div class="hk-row">';
				echo '<div class="hkc-md-6">';
					echo '<div class="hk-row">';
						echo '<div class="hkc-md-2">';
							echo JText::_('FROM').' ';
						echo '</div>';
						echo '<div class="hkc-md-10">';
