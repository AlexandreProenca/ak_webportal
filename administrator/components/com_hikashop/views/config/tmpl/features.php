...
<table class="hk_config_table table" style="width:100%; margin-bottom:0;">
	...
	$arr = array(
		...
		JHTML::_('select.option', 1, JText::_('SIMPLIFIED_BREADCRUMBS_SIMPLIFIED')),
		JHTML::_('select.option', 2, JText::_('SIMPLIFIED_BREADCRUMBS_AUTO')),
	);
	echo JHTML::_('hikaselect.genericlist', $arr, "config[simplified_breadcrumbs]", 'class="custom-select" size="1"', 'value', 'text', $this->config->get('simplified_breadcrumbs', 2));
		?></td>
	</tr>
	<tr>
