		...
		<tbody>
			...
			?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td class="hk_center">
						<?php
							if(isset($row->listing_total)){
								echo $this->currencyHelper->format($row->listing_total,$row->order_currency_id);
							}elseif(isset($this->widget->widget_params->orders_total_calculation) && $this->widget->widget_params->orders_total_calculation=='exclude_fees'){
