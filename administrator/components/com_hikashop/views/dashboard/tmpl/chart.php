...
$name = isset($this->widget->widget_params->content) && is_string($this->widget->widget_params->content) 
	? $this->widget->widget_params->content 
	: '';
...
?>
<div id="chart_<?php echo $id; ?>" class="chart hk_center hikashop_google_graph" style="<?php echo $size; ?> margin:auto;"></div>
