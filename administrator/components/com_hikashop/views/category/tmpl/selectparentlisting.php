						...
						?>
							<tr class="<?php echo "row$k"; ?>">
								...
								<td width="1%" class="hk_center">
									<a href="#" onclick="changeParent(<?php echo (int)$row->category_id;?>,'<?php echo htmlspecialchars(str_replace("'","\'",$row->category_name), ENT_QUOTES, 'UTF-8');?>');window.top.hikashop.closeBox();">
