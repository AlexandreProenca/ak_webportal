...
?><div class="hikashop_zone_import_csv">
	<form action="index.php?option=com_hikashop&ctrl=zone" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		<div class="hikashop_backend_tile_edition">
			<div class="hikashop_tile_block">
				...
				<div class="hikashop_tile_content">
					<p><?php echo JText::_('ZONE_IMPORT_CSV_DESC'); ?></p>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="csv_content" id="csv_content" rows="10" style="width:100%;" placeholder="<?php echo htmlspecialchars("zone_name,zone_code_2\nCalifornia,CA\nNew York,NY\nTexas,TX"); ?>"><?php if(!empty($this->csv_content)) echo htmlspecialchars($this->csv_content); ?></textarea>
						</div>
					</div>
		...
		<input type="hidden" name="task" value="step2importcsv" />
