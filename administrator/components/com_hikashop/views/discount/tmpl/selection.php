	...
	<div class="row-fluid">
		<div class="span12">
			<div class="input-prepend input-append">
				...
				<button class="btn" onclick="this.form.limitstart.value=0;this.form.submit();"><i class="icon-search" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('GO'); ?></span></button>
				<button class="btn" onclick="this.form.limitstart.value=0;document.getElementById('search').value='';this.form.submit();"><i class="icon-remove" aria-hidden="true"></i><span class="element-invisible"><?php echo JText::_('RESET'); ?></span></button>
			</div>
		</div>
	</div>
<?php } else { ?>
