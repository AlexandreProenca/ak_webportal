...
<?php } ?>
<?php // Let plugins inject extra fields into the price edit dialog (e.g. a price category).
if(!empty($this->extraData->priceEditFields)) { echo implode("\r\n", $this->extraData->priceEditFields); } ?>
