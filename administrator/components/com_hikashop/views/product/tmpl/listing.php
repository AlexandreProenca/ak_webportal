...
?>
				<table id="hikashop_product_listing" class="adminlist table table-striped table-hover" cellpadding="1">
					<thead>
						<tr>
							<th scope="col" class="title titlenum"><?php
								echo JText::_( 'HIKA_NUM' );
							?></th>
							<th scope="col" class="title titlebox">
								<input type="checkbox" name="toggle" id="hikashop_product_toggle" value="" onclick="hikashop.checkAll(this);" /><label for="hikashop_product_toggle" class="element-invisible"><?php echo JText::_('SELECT_ALL'); ?></label>
							</th>
							...
							?></th>
							<th scope="col" class="title default"  data-alias="length"><?php
							...
							?></th>
							<th scope="col" class="title default"  data-alias="width"><?php
							...
							?></th>
							<th scope="col" class="title default" data-alias="height"><?php
							...
							?></th>
							<th scope="col" class="title default" data-alias="weight"><?php
							...
							?></th>
							<th scope="col" class="title default" data-alias="hit"><?php
...
<?php
	...
	if(!empty($this->fields)){
		foreach($this->fields as $field){
			...
			echo '<th scope="col" class="title custom_field" data-alias="'.$field->field_realname.'">'.
	...
	if(!empty($this->extrafields)) {
		foreach($this->extrafields as $namekey => $extrafield) {
			echo '<th scope="col" class="hikashop_product_'.$namekey.'_title title">'.$extrafield->name.'</th>'."\r\n";
		}
		$count_extrafields += count($this->extrafields);
	}
?>
							<th scope="col" class="title titleorder"><?php
								if($this->doOrdering) {
...
<!--											<span class="icon-apply" aria-hidden="true"></span> -->
							...
							?></th>
							<th scope="col" class="title titletoggle"><?php
