...
<?php } ?>
	...
	<input type="hidden" name="after" value="<?php echo htmlspecialchars(hikaInput::get()->getString('after', ''), ENT_QUOTES, 'UTF-8'); ?>" />
	<input type="hidden" name="afterParams" value="<?php echo htmlspecialchars(hikaInput::get()->getString('afterParams', ''), ENT_QUOTES, 'UTF-8'); ?>" />
...
<?php
	if(!empty($this->afterParams)) {
		...
		echo '<input type="hidden" name="after" value="'.htmlspecialchars(hikaInput::get()->getString('after', ''), ENT_QUOTES, 'UTF-8').'"/>'."\r\n";
		echo '<input type="hidden" name="afterParams" value="'.htmlspecialchars(hikaInput::get()->getString('afterParams', ''), ENT_QUOTES, 'UTF-8').'"/>'."\r\n";
	}
?>
