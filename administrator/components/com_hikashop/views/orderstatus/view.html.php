...
class OrderstatusViewOrderstatus extends hikashopView
{
	...
	public function listing() {
		...
		$orderstatus_columns = array(
			...
			'locked' => array(
				'text' => JText::_('LOCKED'),
				'title' => JText::_('LOCKED_ORDER_STATUS'),
				'description' => JText::_('LOCKED_DESC'),
				'key' => 'order_locked_statuses',
				'default' => '',
				'type' => 'toggle'
			),
		);
		...
		$orderstatus_columns['withdrawable'] = array(
			'text' => JText::_('HIKA_WITHDRAWABLE'),
			'title' => JText::_('HIKA_WITHDRAW_BUTTON_ON_ORDERS'),
			'description' => JText::_('HIKA_WITHDRAWABLE_DESC'),
			'key' => 'withdrawal_order_statuses',
			'default' => 'delivered',
			'type' => 'toggle'
		);
