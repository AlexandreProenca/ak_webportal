...
?>
				<tr>
					...
					?></label></td>
					<td><div style="display:flex;align-items:center;"><?php
					...
					$uploadUrl = hikashop_completeLink('plugins&task=uploadimage&type='.$type, true);
					echo $popupHelper->display(
						...
						'plugin_image_upload',
						600, 300,
						'class="btn btn-small btn-success" style="margin-left:5px;" title="'.JText::_('HIKA_UPLOAD_IMAGE').'"', '', 'link'
					);
...
?>
				...
				<tr>
					...
					<td>
						...
						echo JHTML::_('select.genericlist', $values, "data[shipping][shipping_params][shipping_tax]" , 'class="custom-select" onchange="hikashopToggleTax(this.value);"', 'value', 'text', @$this->element->shipping_params->shipping_tax); ?>
					</td>
				</tr>
...
?>
				<tr>
					...
					<td>
						<?php echo $this->warehouseType->displayMultiple('data[shipping][shipping_params][shipping_warehouse_filter]', @$this->element->shipping_params->shipping_warehouse_filter, true); ?>
						<br/>
						<?php
						$warehouse_filter_options = array(
							JHTML::_('select.option', '0', JText::_('INCLUDE')),
							JHTML::_('select.option', '1', JText::_('EXCLUDE')),
						);
						echo JHTML::_('hikaselect.radiolist', $warehouse_filter_options, 'data[shipping][shipping_params][shipping_warehouse_filter_type]', '', 'value', 'text', (int)@$this->element->shipping_params->shipping_warehouse_filter_type);
						?>
					</td>
				</tr>
				<tr>
