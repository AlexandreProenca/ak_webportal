...
CREATE TABLE IF NOT EXISTS `#__hikashop_product` (
	...
	KEY `product_alias` (`product_alias`),
...
CREATE TABLE IF NOT EXISTS `#__hikashop_user` (
	...
	PRIMARY KEY (`user_id`),
	UNIQUE KEY `user_email_type` (`user_email`,`user_type`),
...
CREATE TABLE IF NOT EXISTS `#__hikashop_zone` (
	...
	`zone_ordering` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__hikashop_withdrawal` (
