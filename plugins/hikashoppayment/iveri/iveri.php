...
class plgHikashoppaymentIveri extends hikashopPaymentPlugin
{
	...
	function onBeforeOrderCreate(&$order, &$do) {
		...
		$vars = array (
			...
			'Lite_Website_Successful_Url' => $httpsHikashop . 'success',
			'Lite_Website_Fail_Url' => $httpsHikashop . 'fail',
			'Lite_Website_TryLater_Url' => $httpsHikashop . 'trylater',
			'Lite_Website_Error_Url' => $httpsHikashop . 'error',
