...
class plgHikashoppaymentAlipay extends hikashopPaymentPlugin
{
	...
	function onPaymentNotification(&$statuses){
		...
		if((preg_match('/true$/i', $response) && hash_equals($sign, $_POST['sign'])) && ($_POST['trade_status'] == 'TRADE_FINISHED' || $_POST['trade_status'] == 'TRADE_SUCCESS' || $_POST['trade_status'] == 'WAIT_SELLER_SEND_GOODS' || $_POST['trade_status']== 'WAIT_BUYER_PAY')) {
