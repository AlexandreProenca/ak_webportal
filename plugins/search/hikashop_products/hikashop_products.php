...
?><?php
if (!class_exists('JPlugin', false) && class_exists('Joomla\\CMS\\Plugin\\CMSPlugin')) {
	class_alias('Joomla\\CMS\\Plugin\\CMSPlugin', 'JPlugin');
}
if (!class_exists('JPluginHelper', false) && class_exists('Joomla\\CMS\\Plugin\\PluginHelper')) {
	class_alias('Joomla\\CMS\\Plugin\\PluginHelper', 'JPluginHelper');
}
if (!class_exists('JRegistry', false) && class_exists('Joomla\\Registry\\Registry')) {
...
class plgSearchHikashop_products extends JPlugin{
	...
	function onSearch( $text, $phrase='', $ordering='', $areas=null ){
		...
		if(!$variants){
			...
			$filters[]='a.product_type!=\'trash\'';
			$filters2[]='a.product_type!=\'trash\'';
		}
